...
- Programmatic metro pages incl. top-ZIP table from ZIP *data* (count gated by the pre-registered SEO rule; ceiling ~400)
...
- ZIP-level *map* + MapLibre/PMTiles/R2 → DEFERRED (V2, ≤8.4K ZIPs with honest coverage disclosure; see ADR-0004)
